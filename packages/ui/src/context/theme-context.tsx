...
function ThemeProvider({
  ...
  React.useEffect(() => {
    ...
    if (
      storedColorScheme &&
      Object.values(IColorScheme).includes(storedColorScheme as IColorScheme)
    ) {
    ...
    if (
      ...
      setSidebarStateInternal(storedSidebarState as "collapsed" | "expanded");
    } else {
    ...
    if (
      storedSidebarView &&
      Object.values(ISidebarView).includes(storedSidebarView as ISidebarView)
    ) {
