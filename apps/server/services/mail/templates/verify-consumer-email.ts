import {
  ...
  export const verifyConsumerEmailTemplate = (
	payload: TemplatePayloadMap[TemplateEnum.VERIFY_CONSUMER_EMAIL],
  ): string => {
	  ...
	  <div class="email-wrapper" role="main" aria-label="Verify your email">
		<div class="email-content" role="document">
		  ...
		  <div class="email-body">
			...
			<p>Welcome to the Warranty Management System. To complete your consumer account setup and ensure secure access, please verify your email address by clicking the button below:</p>
